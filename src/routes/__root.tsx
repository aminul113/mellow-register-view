...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PANME SHOP — Find your PAN card instantly" },
      { name: "description", content: "Lost your PAN card? Trace and retrieve it securely in seconds with PANME SHOP." },
      { property: "og:title", content: "PANME SHOP — Find your PAN card instantly" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Caveat:wght@600;700&family=Inter:wght@400;500;600;700&display=swap" },
    ],
  }),
