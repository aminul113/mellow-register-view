...
export function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="h-screen w-full overflow-hidden bg-background flex flex-col lg:grid lg:grid-cols-2">
      {/* Left panel */}
      <div className="relative flex items-center justify-center bg-primary text-primary-foreground px-6 py-4 lg:p-12 h-40 lg:h-full shrink-0 lg:shrink">
        ...
        <div className="relative w-full max-w-[220px] lg:max-w-md aspect-[4/3] rounded-[2rem] overflow-hidden shadow-2xl ring-1 ring-white/10 bg-white/95 transition-transform duration-500 hover:scale-[1.01] animate-scale-in">
          <img
