    ...
    <div className="space-y-1 lg:space-y-1.5">
      ...
      <div className="relative">
        <input
          ...
          } bg-input/60 px-3 py-2.5 lg:px-4 lg:py-3 text-sm outline-none transition-all duration-200 focus:border-primary focus:ring-4 focus:ring-primary/15 placeholder:text-muted-foreground`}
        />
        {isPassword && (
          <button
            type="button"
