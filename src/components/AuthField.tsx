    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        <input
          ...
          } bg-background px-4 py-3 text-sm outline-none transition-all duration-200 focus:border-primary focus:ring-4 focus:ring-primary/15 placeholder:text-muted-foreground`}
        />
        {isPassword && (
          <button
            type="button"
